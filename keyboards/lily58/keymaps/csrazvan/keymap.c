 ...
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_LCTRL, KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_GRAVE,  KC_GRAVE,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_DEL,
...
[_SGN] = LAYOUT(
  ...
  _______, _______, KC_BSLASH, KC_LPRN, KC_RPRN, KC_GRAVE,                   _______, KC_QUOTE, KC_UNDERSCORE, KC_EQUAL, KC_COLN, _______,
